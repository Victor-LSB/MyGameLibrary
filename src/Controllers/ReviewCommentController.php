...
class ReviewCommentController {
    ...
    public function __construct() {
        ...
        if ($this->db) {
            $this->commentModel = new ReviewComment($this->db);
    ...
    public function add() {
        ...
        // A análise-alvo precisa existir de fato (o usuário tem esse jogo na biblioteca dele).
        $targetGame = $targetUserId && $gameId ? $this->gameModel->getUserGameInfo($targetUserId, $gameId) : null;
        ...
        $commentId = $this->commentModel->add($targetUserId, $gameId, $authorId, $content, $parentId);
        ...
        $this->notify($targetUserId, $gameId, $authorId, $commentId, $parentId);
