                ...
                <?php if (!empty($activities)): ?>
                    <?php
                        $feedIcons = [
                            ...
                            'status_Platinado' => ['badge' => 'feed-icon-platinum', 'border' => 'border-l-amber-400', 'svg' => '<svg width="100%" height="100%" viewBox="0 0 24 24" fill="currentColor"><path d="M6 3h12v2h2a1 1 0 0 1 1 1v1a5 5 0 0 1-4.53 4.98A6.02 6.02 0 0 1 13 15.9V18h2a1 1 0 1 1 0 2H9a1 1 0 1 1 0-2h2v-2.1a6.02 6.02 0 0 1-3.47-3.92A5 5 0 0 1 3 7V6a1 1 0 0 1 1-1h2V3Zm-2 4v0a3 3 0 0 0 2.4 2.94A9 9 0 0 1 6 7V6H4v1Zm14 0V6h-2v1a9 9 0 0 1-.4 2.94A3 3 0 0 0 18 7Z"/></svg>'],
