...
use Victi\MyGameLibrary\Controllers\ReviewCommentController;
...
$routes = [
    ...
    'review_comment_add' => [ReviewCommentController::class, 'add'],
    'review_comment_delete' => [ReviewCommentController::class, 'delete'],
